...
const spacing = 0.1, 
    ...
    animateFunc = element => {
        ...
        tl.fromTo(element, {scale: 1, opacity: 1}, {scale: 1, opacity: 1, zIndex: 100, duration: 0.5, yoyo: true, repeat: 1, ease: "power1.in", immediateRender: false})
...
// Disable mouse wheel scroll for the gallery
